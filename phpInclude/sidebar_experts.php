...
?>
	...
	<div class="sidebarnav sidebar2"><!-- // SIDE BAR NAV // -->
                        ...
                        <div class="sidebarfilter">
                            ...
                            <li>
                                ...
                                <li>
									...
									<?php 
									if (isset($_GET['tags']) && !empty($_GET['tag_id']) && $_GET['search_type']=="tag")
									{
									?>
				...
				<?php }
				else if (isset($_GET['tags']) && empty($_GET['tag_id']))
				{
					?>
					<input type="hidden" name="description" value="<?php echo trim($_GET['tags']);?>">
					<?php
				}
				?>
				</div>
