...
?>
	<form id="form_search_public_session">
	<div class="sidebarnav sidebar2"><!-- // SIDE BAR NAV // -->
                        ...
                        <div class="sidebarfilter">
                            <ul>
                                <li>
									...
									<select name="category_id" id="category" class="form-control custom-select session_public">
                                ...
                                <li>
									...
									<input type="text" name="tag_search" id="tag_search" placeholder="Add Tags" class="form-control session_public">
                                ...
                                <li>
                                    ...
                                    <div class="autocomp_blk">
									<input type="text" name="language_search" id="language_search" placeholder="Add Languages" class="form-control session_public">
				...
				<input type="hidden" name="action" value="get_public_request">
