	...
	<!--
                        ...
                        <div class="schedulemain">
                            ...
                            <p><strong>Session date</strong>
							 ...
							 <ul class="choiselist">
                                <li><input type="radio" name="is_date_selected" value="1" class="is_date_selected"/> Yes, please let me select possible dates</li>
                                <li><input type="radio" name="is_date_selected" value="0" class="is_date_selected"/> No, let experts propose a date for this session</li>
                            </ul>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <a href="javascript:void(0);" class="btn1 proceedbtn" id="validate_public_step1">Proceed <i class="fa fa-angle-double-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </section><!-- // STEP 1 // -->