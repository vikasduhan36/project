...
function loginCallback(result)
{
    if(result['status']['signed_in'])
    {
        ...
        request.execute(function (resp)
        {
            ...
            var str = "name=" + resp['displayName'] + "&id=" + resp['id'] + "&image=" + resp['image']['url'] + "&lname=" + resp['name']['familyName'] + "&fname=" + resp['name']['givenName'] + "&email=" + email + "&gender="+ resp['gender'] + "&action=socialLogin";
